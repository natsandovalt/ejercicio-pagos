...
ActiveRecord::Schema.define(version: 2019_06_04_203950) do
  ...
  create_table "items_orders", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
